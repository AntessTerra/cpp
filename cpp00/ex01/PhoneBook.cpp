...
std::string	PhoneBook::truncate(std::string str, int width)
{
...
std::string	PhoneBook::getValueFromUser(std::string message)
{
	std::string	out;
...
void	PhoneBook::printAtString(std::string str){
...
void	PhoneBook::printAtNum(int n)
{
